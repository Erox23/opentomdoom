...
export AUTOROOT="/home/<USER>/build" //Change this to your username instead of <USER> and /build is where you compiled OpenTom
...
export DOWNLOADS="$ROOT/Downloads"    //some of those are not really needed, I have to fix it
